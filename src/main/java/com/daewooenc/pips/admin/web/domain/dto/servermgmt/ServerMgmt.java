...
@JsonPropertyOrder({"rownum", "hmnetId", "hmnetKeyCd", "svrTpCd", "bizcoCd", "serlNo", "urlCont", "stsCd", "keepAliveCycleCont",
...
public class ServerMgmt {
    ...
    @JsonProperty("rownum") @JsonSerialize(using = ToStringSerializer.class)
    private int rownum;
