    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '{drag}\n' +
                '<div class="clearfix"></div>\n' +
                '<input type="text" id="ptype-nm" name="ptypeNm[]" placeholder="평형 명을 입력하세요."/>\n' +
                '<div class="clearfix"></div>\n' +
                '<input type="text" id="ptype-dim-qty" name="ptypeDimQty[]" placeholder="평형 면적량을 입력하세요."/>\n' +
                '<div class="clearfix"></div>\n' +
                '<input type="text" id="sup-dim-qty" name="supDimQty[]" placeholder="공급 면적량을 입력하세요."/>\n' +
                '<div class="clearfix"></div>\n' +
                '<input type="text" id="link-url" name="linkUrl[]" placeholder="배너 링크를 입력하세요."/>';
            //noinspection HtmlUnknownAttribute
        ...
        _uploadBatch: function () {
            var self = this, files = self.filestack, total = files.length, params = {}, fnBefore, fnSuccess, fnError,
                ...
                setAllUploaded, userInputParam = self.userInputParam;
            console.log("userInputParam settings value: " + userInputParam);
