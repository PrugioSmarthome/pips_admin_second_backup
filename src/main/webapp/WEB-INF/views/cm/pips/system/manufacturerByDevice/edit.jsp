...
<script type="text/javascript">
    ...
    $("#houscplxCd").val("<c:out value="${manufacturerByDeviceEdit.houscplxCd}"/>");
    $("#houscplxNm").val("<c:out value="${manufacturerByDeviceEdit.houscplxNm}"/>");
    $("#deviceTpCd_").val("<c:out value="${manufacturerByDeviceEdit.deviceTpCdOrgn}"/>");
    $("#deviceTpCd").val("<c:out value="${manufacturerByDeviceEdit.deviceTpCdOrgn}"/>");
    $("#deviceMfCd").val("<c:out value="${manufacturerByDeviceEdit.deviceMfCd}"/>");
    $("#deviceMfNm").val("<c:out value="${manufacturerByDeviceEdit.commCdNm}"/>");

    $("#houscplxCdDB").val("<c:out value="${manufacturerByDeviceEdit.houscplxCd}"/>");
    $("#deviceTpCdDB").val("<c:out value="${manufacturerByDeviceEdit.deviceTpCdOrgn}"/>");
    $("#deviceMfCdDB").val("<c:out value="${manufacturerByDeviceEdit.deviceMfCd}"/>");
    ...
    function formsubmit(){
        ...
        var houscplxCdDB = $("#houscplxCdDB").val();
        var deviceTpCdDB = $("#deviceTpCdDB").val();
        var deviceMfCdDB = $("#deviceMfCdDB").val();

        var houscplxCd = $("#houscplxCd").val();
        var deviceTpCd = $("#deviceTpCd_").val();
        var deviceMfCd = $("#deviceMfCd").val();

        if(houscplxCdDB != houscplxCd || deviceTpCdDB != deviceTpCd || deviceMfCdDB != deviceMfCd){
            var flag = "false";
            $.ajax({
...
<form:form id="form_modify" action="/cm/system/manufacturerByDevice/editAction" name="edit" commandName="edit" method="post">
      ...
      <input type="text" id="houscplxCdDB" name="houscplxCdDB" style="width:0;height:0;visibility:hidden"/>
      <input type="text" id="deviceTpCdDB" name="deviceTpCdDB" style="width:0;height:0;visibility:hidden"/>
      <input type="text" id="deviceMfCdDB" name="deviceMfCdDB" style="width:0;height:0;visibility:hidden"/>
</form:form>
