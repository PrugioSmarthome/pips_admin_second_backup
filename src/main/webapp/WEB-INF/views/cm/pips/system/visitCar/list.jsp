...
<script type="text/javascript">
    ...
    function btn_search(){
        ...
        $("#visitDateStart").val($("#start").val().replace(/\./gi,''));
        $("#visitDateEnd").val($("#end").val().replace(/\./gi,''));
                    ...
                    <tr>
                        ...
                        <td style="width:350px">
                            <div class="input-daterange input-group" id="datepicker">
                                <input type="text" class="form-control inp_calendar" name="start" id="start" value="<c:out value="${visitDateStart}"/>" />
                                <span class="bul_space">~</span>
                                <input type="text" class="form-control inp_calendar" name="end" id="end" value="<c:out value="${visitDateEnd}"/>" />
                            </div>
                            <script type="text/javascript">
                            $('#start').datepicker({
                                format: "yyyy.mm.dd",
...
<form:form id="form_search" action="/cm/visit/car/search" name="info" commandName="info" method="post">
      ...
      <input type="text" id="visitDateStart" name="visitDateStart" style="width:0;height:0;visibility:hidden"/>
      <input type="text" id="visitDateEnd" name="visitDateEnd" style="width:0;height:0;visibility:hidden"/>
</form:form>
...
<script type="text/javascript">
    var visitDateStart = '<c:out value="${visitDateStart}"/>';
    if(visitDateStart != ""){
        var year = visitDateStart.substring(0,4);
        var month = visitDateStart.substring(4,6);
        var day = visitDateStart.substring(6);

        visitDateStart = year + "." + month + "." + day;

        $("#start").val(visitDateStart);
    }
    var visitDateEnd = '<c:out value="${visitDateEnd}"/>';
    if(visitDateEnd != ""){
        var year = visitDateEnd.substring(0,4);
        var month = visitDateEnd.substring(4,6);
        var day = visitDateEnd.substring(6);

        visitDateEnd = year + "." + month + "." + day;

        $("#end").val(visitDateEnd);
    }

$('.datepicker').css({"margin-top": "-250px"})
</script>