...
<body>
<form:form action="/cm/system/facility/addFacilityInfoAction" id="facilityInfo" name="facilityInfo" commandName="facilityInfo" method="post">
...
<form:form id="listForm" action="/cm/system/facility/list" name="facilityInfo" commandName="facilityInfo" method="post">
</form:form>