                    ...
                    <tr>
                        ...
                        <td>
                            <select name="selLnkAtchFileGrpTpCd" id="selLnkAtchFileGrpTpCd" class="custom-select">
                                ...
                                <option value="GUIDE">단지별 가이드</option>
                                <option value="LIVING_GUIDE">리빙가이드북</option>
                                <option value="INTRO_GUIDE">단지서비스소개</option>
                            </select>
                        </td>
                        <th>문서종류</th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="selComplex" id="selComplex" class="custom-select">
                                <option value="ALL" <c:if test="${documentDetail.svcNotiTpCd eq 'ALL'}">selected</c:if>>전체</option>
                                <option value="PART" <c:if test="${documentDetail.svcNotiTpCd eq 'PART'}">selected</c:if>>특정단지</option>
                            </select>
                        </td>
                        <td colspan="2">
                            <div id="btnHouscplx">
