...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#commCdGrpCd").val("<c:out value="${standardCodeEdit.commCdGrpCd}"/>");
        $("#commCdGrpCdDB").val("<c:out value="${standardCodeEdit.commCdGrpCd}"/>");

        $("#commCd").val("<c:out value="${standardCodeEdit.commCd}"/>");
        $("#commCdDB").val("<c:out value="${standardCodeEdit.commCd}"/>");
    ...
    function formsubmit(){
        ...
        if(($("#commCdGrpCdDB").val() != $("#commCdGrpCd").val()) || ($("#commCdDB").val() != commCd)){
            var flag = "false";
            $.ajax({
            ...
            <table class="table2">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                <input type="text" id="commCdGrpNm_" class="form-control" value="<c:out value="${standardCodeEdit.commCdGrpNm}"/>(<c:out value="${standardCodeEdit.commCdGrpCd}"/>)" disabled />
                    ...
                    <tr>
                        <th>공통코드</th>
                        <td>
                            <input type="text" name="commCd_" id="commCd_" class="form-control" value="<c:out value="${standardCodeEdit.commCd}"/>"/>
                        </td>
                    </tr>
                    <tr>
                        <th>공통코드명</th>
                        <td>
                            <input type="text" name="commCdNm_" id="commCdNm_" class="form-control" value="<c:out value="${standardCodeEdit.commCdNm}"/>"/>
                        </td>
                    </tr>
                    <tr>
                        <th>공통 코드 설명</th>
                        <td>
                            <input type="text" name="rem_" id="rem_" class="form-control" value="<c:out value="${standardCodeEdit.rem}"/>"/>
                        </td>
                    </tr>
                </tbody>
            </table>
...
<form:form id="form_edit" action="/cm/system/standardCode/editStandardCode" name="addGroupCode" commandName="addGroupCode" method="post">
      ...
      <input type="text" id="commCdDB" name="commCdDB" style="width:0;height:0;visibility:hidden"/>
