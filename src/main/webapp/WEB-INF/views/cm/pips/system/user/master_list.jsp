...
<script type="text/javascript">
    ...
    function excel(){
        ...
        $.ajax({
            ...
            success: function(blob){
                ...
                link.download= today+"_마스터 계정 관리.xlsx";
                link.click();
            },
            error: function(e){
    ...
    function register(){
        location.href = "/cm/system/userMaster/add";
    }
...
<form:form id="form_search" action="/cm/system/userMaster/list" name="info" commandName="info" method="post">
