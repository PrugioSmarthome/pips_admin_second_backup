...
<script type="text/javascript">
    ...
    function save(){
        $("#housingCplxFacility").submit();
    }
</script>
<body>
<form:form action="/cm/housingcplx/info/addFacilityInfoAction" id="housingCplxFacility" name="housingCplxFacility" commandName="housingCplxFacility" method="post">
        ...
        <div class="top_area">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <div style="text-align:right;" class="right_area">
                                <button style="margin-top:10px;" class="btn btn-gray btn-sm" type="button" onclick="fileDownload('시설업체_엑셀등록양식.xls','<c:url value="/files/facility_sample.xls"/>')">샘플양식 다운로드</button>
                            </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="table_wrap2">
                <table class="table" id="table1">
                    <thead>
                        <tr>
                            <th scope="col" style="background-image:none">대공종</th>
                            <th scope="col">업체명</th>
...
<form:form id="listForm" action="/cm/housingcplx/info/facilityInfo/view" name="facilityInfo" commandName="facilityInfo" method="post">
