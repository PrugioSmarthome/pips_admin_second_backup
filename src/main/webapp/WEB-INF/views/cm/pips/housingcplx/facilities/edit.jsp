...
<body>
<form:form action="/cm/housingcplx/info/editFacilityInfoAction" id="housingCplxFacility" name="housingCplxFacility" commandName="housingCplxFacility" method="post">
