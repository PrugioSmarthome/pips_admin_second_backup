				...
				<div class="modal-body">
					...
					<script type="text/javascript">
						...
						$('#file').on('filebatchuploaderror', function(event, data, previewId, index) {
                            ...
                            location.href = "/cm/housingcplx/info/plot/edit?houscplxCd=" + houscplxCd + "&ptypeTpCd=PLOT_PLAN";
                        });
