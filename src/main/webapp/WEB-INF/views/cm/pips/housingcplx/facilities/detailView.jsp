...
<form:form id="form_modify" action="/cm/housingcplx/info/facilityInfo/detailEdit" name="housingcplx" commandName="housingcplx" method="post">
...
<form:form id="form_back" action="/cm/housingcplx/info/facilityInfo/view" name="housingcplx" commandName="housingcplx" method="post">
      <input type="text" id="back_houscplxCd" name="houscplxCd" value="<c:out value="${houscplxCd}"/>" style="width:0;height:0;visibility:hidden"/>
</form:form>