    ...
    <div class="container">
        ...
        <div class="tab_wrap">
            <ul>
                ...
                <li class="on"><a href="#">우리 단지 알림</a></li>
        ...
        <c:choose>
            <c:when test="${not empty houscplxInfoList}">
                <div id="carousel" class="carousel slide" data-ride="carousel" >
                    <ol class="carousel-indicators">
                        <c:forEach items="${houscplxInfoList}" var="list" varStatus="status">
                            <c:choose>
            ...
            <c:otherwise>
                <h2 style="text-align:center;color:gray">우리 단지 알림 이미지를 등록해주세요</h2>
            </c:otherwise>
        </c:choose>
...
<form:form id="form_list" action="/cm/housingcplx/info/notice/edit" name="housingcplx" commandName="housingcplx" method="post">
				...
				<div class="modal-body">
					...
					<script type="text/javascript">
						...
						$('#file').on('filebatchuploaderror', function(event, data, previewId, index) {
                            ...
                            console.log(index);
                            location.href = "/cm/housingcplx/info/notice/view?houscplxCd=" + houscplxCd + "&ptypeTpCd=HOUSCPLX_INFO";
                        });
