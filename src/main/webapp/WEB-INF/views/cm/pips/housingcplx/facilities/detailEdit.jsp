...
<script type="text/javascript">
    ...
    function add(){
        var table = $('#table1').DataTable();
            table.row.add([
                    "<input type='text' name='newperchrgNm' class='form-control'/>",
    ...
    function save() {
        ...
        if(check == "Y"){
            ...
            var cd = "<c:out value="${houscplxCd}"/>";
            $("#edit_houscplxCd").val(cd);
    ...
    function deleteOne(facltBizcoId, facltBizcoCaddrId) {
        ...
        $("#delete_facltBizcoId_houscplxCd").val()
        $("#delForm").submit();
    }
...
<div id="container">
    ...
    <div class="container">
        ...
        <c:if test="${empty facilityInfoCaddrList}">
            <div class="table_wrap2" id="eximport" style="margin-bottom:20px;">
                <table class="table2">
                    <colgroup>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <div style="text-align:right;" class="right_area">
                                    <button style="margin-top:10px;" class="btn btn-gray btn-sm" type="button" onclick="fileDownload('시설업체연락처_엑셀등록양식.xls','<c:url value="/files/facility_addr_sample.xls"/>')">샘플양식 다운로드</button>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                    ...
                    <c:choose>
                        <c:when test="${not empty facilityInfoCaddrList}">
                            <c:forEach items="${facilityInfoCaddrList}" var="list" varStatus="status">
                                <tr>
                                    <td class="text-center"><input type="text" id="perchrgNm" name="perchrgNm" value="<c:out value="${list.perchrgNm}"/>" class="form-control" /></td>
...
<form:form id="detailForm" action="/cm/housingcplx/info/facilityInfo/detailView" name="facilityInfo" commandName="facilityInfo" method="post">
...
<form:form id="editForm" action="/cm/housingcplx/info/editFacilityInfoCaddrAction" name="facilityInfo" commandName="facilityInfo" method="post">
...
<form:form id="delForm" action="/cm/housingcplx/info/deleteFacilityInfoCaddrAction" name="facilityInfo" commandName="facilityInfo" method="post">
    ...
    <input type="text" id="delete_facltBizcoId_houscplxCd" name="houscplxCd" style="width:0;height:0;visibility:hidden"/>
