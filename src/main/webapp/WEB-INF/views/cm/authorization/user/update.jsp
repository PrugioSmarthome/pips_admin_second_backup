...
function init(){
	...
	var accountLock = "${user.accountLock}";
	...
	// 계정 잠김 Set
	$("#accountLock > option[value = " + accountLock + "]").attr("selected", "ture");
}

function goUpdate() {
	if($("#password").val() != "" && isValid() == false){
		return;
	}
...
function goDelete(){
	...
	$("#user").attr("action", "/cm/authorization/user/deleteAction");
	$("#user").submit();
}
...
<div id="container">
      ...
      <section>
         <article>
			<form:form method="post" action="/cm/authorization/user/updateAction" name="user" commandName="user">
            ...
            <header>
               <h1><spring:message code="label.user.update.text"/></h1>
               <div class="icons">
               		<%-- <ntels:auth auth="${menuAuth}"> --%>
					<a href="#" id="btn_update" class="ico_save" title='<spring:message code="label.common.icon.save.text"/>'><spring:message code="label.common.icon.save.text"/></a>
					<a href="#" id="btn_delete" class="ico_del" title='<spring:message code="label.common.icon.delete.text"/>'><spring:message code="label.common.icon.delete.text"/></a>
               		<%-- </ntels:auth> --%>
			...
			<p class="caution"><spring:message code="msg.common.error"/></p>
			</c:if>
            ...
            <tr>
               ...
               <td colspan="3">
					<input id="userId" name="userId" value="${user.userId}" placeholder="<spring:message code="label.user.userId.text"/>" type="text" class="warInput" maxlength="50" readonly>
            ...
            <tr>
               <th><label><spring:message code="label.user.password.text"/></label></th>
               <td>
               ...
               <th><label><spring:message code="label.user.passwordRe.text"/></label></th>
               <td>
            ...
            <tr>
               ...
               <th><label><spring:message code="label.user.accountLock.text"/></label></th>
               <td>
	               	<select id="accountLock" name="accountLock">
            ...
            <tr>
               ...
               <td>
               	  <input id="passwordDueDate" name="passwordDueDate" value="${user.passwordDueDate}" placeholder="<spring:message code="label.user.passwordDueDate.text"/>" maxlength="10" class="px100 date" readonly="readonly">
