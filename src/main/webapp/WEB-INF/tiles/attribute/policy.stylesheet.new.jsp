...
<link rel="stylesheet" type="text/css" href="<c:url value="/styles/ui.dynatree.css" />">
<link rel="stylesheet" type="text/css" href="<c:url value="/styles/custom_policy.css" />">
<link rel="stylesheet" type="text/css" href="<c:url value="/styles/fontawesome-all.css" />">